...
import com.backend.service.utils.ServiceBackendConstants;
import com.backend.service.utils.SpringLiquibaseUtil;
...
public class LiquibaseConfiguration {
    ...
    public SpringLiquibase liquibase(@Qualifier("taskExecutor") Executor executor,
        ...
        if (env.acceptsProfiles(Profiles.of(ServiceBackendConstants.SPRING_PROFILE_NO_LIQUIBASE))) {
